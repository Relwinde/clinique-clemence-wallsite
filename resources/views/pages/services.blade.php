                        ...
                        <div class="owl-carousel owl-theme">
                            <div class="item">
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-xs-12 d-none d-sm-none d-md-block">
                                        <div class="cat_about ser_section">
                                            <div class="icon_wrapper">
                            ...
                            <div class="item">
                                <div class="row">
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 d-none d-sm-block">
                                        <div class="cat_about ser_section">
                                            <div class="icon_wrapper">
                                                <img src="images/icon1.png" alt="img" class="img-responsive">
                                            </div>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-xs-12 d-none d-sm-none d-md-none d-lg-block">
                                        <div class="cat_about ser_section">
                                            <div class="icon_wrapper">
                                                <img src="images/icon3.png" alt="img" class="img-responsive">
                                            </div>
