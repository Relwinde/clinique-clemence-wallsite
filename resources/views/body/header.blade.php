        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="top_login">
                        <ul>
                            <li><i class="fa fa-sign-in" aria-hidden="true"></i><a href="login_register.html">Log In / Sign Up	</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div id='cssmenu' class="wd_single_index_menu">
                        <ul>
                            <li class='has-sub'><a href='#'>index</a>
                                <ul>
                                    <li><a href="index_clinic.html">index Clinic</a>
                                    </li>
									<li><a href="index_corona.html">index Corona</a>
									</li>
                                    <li><a href="index_hospital.html">index Hospital</a>
                                    </li>
                                    <li><a href="index_gynecologycal.html">index Gynecologycal</a>
                                    </li>
                                    <li><a href="index_dental.html">index Dental</a>
                                    </li>
                                    <li><a href="index_eye.html">Index Eye</a>
                                    </li>
                                    <li>
                            ...
                            <li class='has-sub'><a href="{{url('services')}}">services</a>
                                <ul>
